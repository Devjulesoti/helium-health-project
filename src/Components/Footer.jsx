...
import facebook from '../images/Shape.png'
import instagram from '../images/Shape (1).png'
import twitter from '../images/Combined Shape.png'
import In from '../images/Combined Shape (1).png'
